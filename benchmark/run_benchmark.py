...
## Images
26. Always resize before reading. Smaller images = fewer tokens.
27. Write observations immediately after viewing an image. Text descriptions survive compaction cheaply.
28. Never read the same image twice. Notes from first read are 10-20x cheaper than re-encoding.

## Model & Effort
29. Cheapest model for the task. Sonnet for mechanical work. Opus for judgment.
