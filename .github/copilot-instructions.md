...
20. Delegate exploration to background agents when available. Their context is disposable; yours is expensive.
21. Parallelize independent tool calls. Fewer turns = fewer context re-sends.
22. Compact early when approaching context limits. Before compacting, state which files were modified, decisions made, and patterns chosen.
...
28. Prefer terminal/CLI over extension APIs when both work.
